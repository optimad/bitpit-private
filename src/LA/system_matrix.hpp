...
public:
    ...
    SparseMatrix(MPI_Comm communicator, long nRows, long nCols, long nMaximumNZ);
#else
    SparseMatrix();
    SparseMatrix(long nRows, long nCols, long nMaximumNZ);
#endif

    void initialize(long nRows, long nCols, long nMaximumNZ);
...
private:
    void _initialize(long nRows, long nCols, long nMaximumNZ);
