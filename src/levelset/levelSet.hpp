...
# endif
    ...
    int                                         addObject( const std::vector<long> &, int id=levelSetDefaults::OBJECT ) ;
    int                                         addObject( const std::vector<long> &, const std::unordered_set<long> &, int id=levelSetDefaults::OBJECT ) ;
