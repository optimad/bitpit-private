...
int subtest_001(VolOctree *patch_2D, VolOctree *patch_2D_restored)
{
    ...
    stringVector[0] = "Test 0";
    stringVector[1] = "Test 1";
    stringVector[2] = "Test 2";
...
//     exit(0);
    ...
    std::cout << "b 0 " << booleanStorage.rawAt(0) << std::endl;
    std::cout << "b 1 " << booleanStorage.rawAt(1) << std::endl;
    std::cout << "b 2 " << booleanStorage.rawAt(2) << std::endl;
    std::cout << "b 3 " << booleanStorage.rawAt(3) << std::endl;
    std::cout << "b 4 " << booleanStorage.rawAt(4) << std::endl;

    std::cout << "d 0 0 " << doubleStorage.rawAt(0, 0) << std::endl;
    std::cout << "d 0 1 " << doubleStorage.rawAt(0, 1) << std::endl;
    std::cout << "d 0 2 " << doubleStorage.rawAt(0, 2) << std::endl;
    std::cout << "d 0 3 " << doubleStorage.rawAt(0, 3) << std::endl;
    std::cout << "d 0 4 " << doubleStorage.rawAt(0, 4) << std::endl;

    std::cout << "d 1 0 " << doubleStorage.rawAt(1, 0) << std::endl;
    std::cout << "d 1 1 " << doubleStorage.rawAt(1, 1) << std::endl;
    std::cout << "d 1 2 " << doubleStorage.rawAt(1, 2) << std::endl;
    std::cout << "d 1 3 " << doubleStorage.rawAt(1, 3) << std::endl;
    std::cout << "d 1 4 " << doubleStorage.rawAt(1, 4) << std::endl;

    std::cout << "d 2 0 " << doubleStorage.rawAt(2, 0) << std::endl;
    std::cout << "d 2 1 " << doubleStorage.rawAt(2, 1) << std::endl;
    std::cout << "d 2 2 " << doubleStorage.rawAt(2, 2) << std::endl;
    std::cout << "d 2 3 " << doubleStorage.rawAt(2, 3) << std::endl;
    std::cout << "d 2 4 " << doubleStorage.rawAt(2, 4) << std::endl;

    std::cout << "ad 0 0 " << arrayDoubleStorage.rawAt(0, 0) << std::endl;
    std::cout << "ad 0 1 " << arrayDoubleStorage.rawAt(0, 1) << std::endl;
    std::cout << "ad 0 2 " << arrayDoubleStorage.rawAt(0, 2) << std::endl;
    std::cout << "ad 0 3 " << arrayDoubleStorage.rawAt(0, 3) << std::endl;
    std::cout << "ad 0 4 " << arrayDoubleStorage.rawAt(0, 4) << std::endl;


    std::cout << "string " << stringValue << std::endl;

    std::cout << "string vector [0] " << stringVector[0] << std::endl;
    std::cout << "string vector [1] " << stringVector[1] << std::endl;
    std::cout << "string vector [2] " << stringVector[2] << std::endl;
